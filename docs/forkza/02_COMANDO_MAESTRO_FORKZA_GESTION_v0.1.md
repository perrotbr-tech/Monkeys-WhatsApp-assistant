...
|---|---|
| Conversación y reservas | Implementado en la rama funcional PR #5 |
| Automatización de retención | Implementada en la rama funcional PR #5 |
| Multi-gimnasio y autenticación demo | Implementado; autenticación en verde |
| Socios, membresías y pagos | Implementado en modo demo; requiere endurecimiento productivo |
| Cinco agentes comerciales | Implementados mediante reglas deterministas |
| WhatsApp oficial | Contrato/preparación; integración real pendiente |
| Persistencia productiva | Pendiente |
| Aislamiento productivo | Parcial; revisar rutas públicas de pago por referencia |
| Forja Training | Ausente |

Base de evidencia: `cursor/socios-pagos-7236` @ `b03fd73`, con 67/68 pruebas al 19-09-2026. “Implementado” describe el prototipo de esa rama, no preparación para producción.
