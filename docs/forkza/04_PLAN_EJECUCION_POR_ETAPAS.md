...
|---|---|---|
| E0 | Consolidar rama base | 63/63 pruebas y sin cambios funcionales no autorizados |
...
Crear una rama de integración desde `cursor/socios-pagos-7236`, confirmar que incluye PR #4 y corregir exclusivamente las dos pruebas fallidas.

### Alcance

- verificar commits y ancestros;
- crear `integration/forkza-core-baseline`;
- reproducir 63 pruebas;
- corregir dependencia del día real mediante control de fecha o fixture;
- corregir el fallo de `tests/auth.test.js` sin debilitar autenticación;
