...
1. `00_INSTRUCCIONES_CURSOR_FORKZA_FORJA.md`
2. `01_ARQUITECTURA_COMPARTIDA_FORKZA_FORJA.md`
3. `02_COMANDO_MAESTRO_FORKZA_GESTION_v0.1.md`
4. `03_COMANDO_MAESTRO_FORJA_TRAINING_v0.3.md`
5. `04_PLAN_EJECUCION_POR_ETAPAS.md`
6. el prompt específico de la etapa autorizada.

Si existe contradicción:

1. manda el prompt de la etapa para su alcance;
2. luego estas instrucciones raíz;
3. luego la arquitectura compartida;
4. luego el comando maestro del dominio afectado.
...
- `cursor/socios-pagos-7236` (`b03fd73`): 61/63 pruebas en verde; contiene la rama multi-gimnasio.
...
La primera puerta de calidad es 63/63 pruebas en la rama de integración.
