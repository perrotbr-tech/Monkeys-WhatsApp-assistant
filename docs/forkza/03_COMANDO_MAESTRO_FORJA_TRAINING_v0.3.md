...
Este documento es la fuente de verdad funcional de Forja Training, no evidencia de que sus funciones estén implementadas. Debes leer antes `../contexto/00_INDICE_CONTEXTO_VIVO.md`, respetar sus decisiones, límites y terminología, y contrastar cada tarea con el repositorio vigente. No conviertas sugerencias de Forja Training en reglas deportivas oficiales ni inventes requisitos en los apartados marcados como pendientes.
