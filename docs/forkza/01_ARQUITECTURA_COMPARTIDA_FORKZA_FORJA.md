...
- PR/rama `cursor/multi-gimnasio-soma-dd14`, commit `f721818`: ancestro directo de la rama siguiente; su PR registra 56/56 al cierre de esa etapa.
- PR/rama `cursor/socios-pagos-7236`, commit `b03fd73`: 68 pruebas, 67 aprobadas y 1 fallida al reproducir la suite el 19-09-2026.
- La autenticación está en verde. La única falla vigente es un test de `crosstraining mañana` que depende de la fecha real y cae en domingo con la fecha de auditoría.
