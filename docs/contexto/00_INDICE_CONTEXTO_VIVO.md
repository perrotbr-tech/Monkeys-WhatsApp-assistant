...
Base `main`: `a428313` (Demo Forja PR #19; hotfix Pages `2629fdc`; E3 `9fb3414`).
Etapa cerrada: E3. E4/E5 no iniciadas. Forja Training productivo no iniciado (solo demo `forja-demo/`, ahora con módulo Finanzas ficticio).
