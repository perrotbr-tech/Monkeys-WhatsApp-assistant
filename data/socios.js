...
const MONKEYS_SOCIOS = [
  { id: 's01', nombre: 'Camila Torres', telefono: '+56961000001', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-01-10' },
  { id: 's02', nombre: 'Diego Nunez', telefono: '+56961000002', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2025-02-01' },
  ...
  { id: 's05', nombre: 'Javiera Munoz', telefono: '+56961000005', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-04-04' },
  { id: 's06', nombre: 'Andres Pino', telefono: '+56961000006', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2025-05-15' },
  { id: 's07', nombre: 'Paula Vidal', telefono: '+56961000007', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-06-01' },
  { id: 's08', nombre: 'Tomas Bravo', telefono: '+56961000008', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: '2025-01-22' },
  { id: 's09', nombre: 'Isidora Lagos', telefono: '+56961000009', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2025-07-07' },
  { id: 's10', nombre: 'Nicolas Reyes', telefono: '+56961000010', sedeId: 'alta-vista', claseFavorita: 'Cross Training', fechaIngreso: '2025-02-14' },
  { id: 's11', nombre: 'Fernanda Silva', telefono: '+56961000011', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2024-12-01' },
  { id: 's12', nombre: 'Benjamin Castro', telefono: '+56961000012', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: null },
  { id: 's13', nombre: 'Antonia Leon', telefono: '+56961000013', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2025-03-03' },
  { id: 's14', nombre: 'Martin Araya', telefono: '+56961000014', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: '2025-04-18' },
  { id: 's15', nombre: 'Catalina Vega', telefono: '+56961000015', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-01-08' },
  ...
  { id: 's17', nombre: 'Daniela Morales', telefono: '+56961000017', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2024-10-10' },
  { id: 's18', nombre: 'Ignacio Parra', telefono: '+56961000018', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: '2025-06-11' },
  { id: 's19', nombre: 'Francisca Ortiz', telefono: '+56961000019', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-02-02' },
  { id: 's20', nombre: 'Vicente Salas', telefono: '+56961000020', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: '2025-03-30' },
  { id: 's21', nombre: 'Amanda Rivas', telefono: '+56961000021', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-01-15' },
  { id: 's22', nombre: 'Bruno Caceres', telefono: '+56961000022', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: '2025-02-08' },
  { id: 's23', nombre: 'Cecilia Paredes', telefono: '+56961000023', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2024-12-12' },
  ...
  { id: 's25', nombre: 'Elena Fuenzalida', telefono: '+56961000025', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-04-20' },
  { id: 's26', nombre: 'Franco Villalobos', telefono: '+56961000026', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: '2025-01-28' },
  { id: 's27', nombre: 'Gabriela Opazo', telefono: '+56961000027', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2024-11-05' },
  { id: 's28', nombre: 'Hugo Saavedra', telefono: '+56961000028', sedeId: 'alta-vista', claseFavorita: 'Cross Training', fechaIngreso: '2025-05-02' },
  { id: 's29', nombre: 'Ines Carmona', telefono: '+56961000029', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-02-19' },
  { id: 's30', nombre: 'Julian Toledo', telefono: '+56961000030', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: '2024-10-22' },
  { id: 's31', nombre: 'Karla Orellana', telefono: '+56961000031', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2025-06-08' },
  ...
  { id: 's33', nombre: 'Monica Godoy', telefono: '+56961000033', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-01-04' },
  { id: 's34', nombre: 'Nestor Palma', telefono: '+56961000034', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: '2024-12-28' },
  { id: 's35', nombre: 'Olga Sepulveda', telefono: '+56961000035', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2025-04-11' },
  { id: 's36', nombre: 'Patricio Nuñez', telefono: '+56961000036', sedeId: 'alta-vista', claseFavorita: 'Cross Training', fechaIngreso: '2025-02-25' },
  { id: 's37', nombre: 'Quena Aravena', telefono: '+56961000037', sedeId: 'felix-garcia', claseFavorita: 'Spinning', fechaIngreso: '2025-05-30' },
  { id: 's38', nombre: 'Renato Lagos', telefono: '+56961000038', sedeId: 'alta-vista', claseFavorita: 'Yoga', fechaIngreso: '2025-03-09' },
  { id: 's39', nombre: 'Sofia Venegas', telefono: '+56961000039', sedeId: 'felix-garcia', claseFavorita: 'Funcional', fechaIngreso: '2024-11-18' },
